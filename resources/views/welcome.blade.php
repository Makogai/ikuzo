                ...
                <div class="row shows_row">
                    ...
                    <div class="col-lg-2 col-sm-12">
                        <div class="row">
                            <div class="col-12">
                                <a href="https://www.listennotes.com/podcasts/ikuzos-unscripted-podcast-petar-dzakovic-qkyaYD9ponh/" title="Ikuzo’s Unscripted Podcast | Listen Notes"><img loading="lazy" src="https://cdn-images-2.listennotes.com/images/podcasts/qkyaYD9ponh/badge/" alt="Ikuzo’s Unscripted Podcast | Listen Notes" style="height: auto; max-width: 100%; width: 100%;" /></a>
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            <a href="https://podcasts.apple.com/us/podcast/ikuzos-unscripted-podcast/id1586974342?itsct=podcast_box_badge&amp;itscg=30200&amp;ls=1"
                                                               style="display: inline-block; overflow: hidden; border-radius: 13px; width: 100%;"><img
                                                                    src="https://tools.applemediaservices.com/api/badges/listen-on-apple-podcasts/badge/en-us?size=250x83&amp;releaseDate=1649430000&h=f256461c7d011217ebace5df0d3768e2"
                                                                    alt="Listen on Apple Podcasts"
                                                                    style="border-radius: 13px; width: 100%;"></a>
                                                        </div>
                            <div class="col-12 mt-3">
                                <a href="https://open.spotify.com/show/3FLnOT2GnvWBh2aqJq0sR0"
                                   style="display: inline-block; overflow: hidden; border-radius: 13px; width: 100%;"><img
                            ...
                            <div class="col-12 mt-3">
                                <a href="https://music.amazon.com/podcasts/85fdea98-35dd-4813-8bab-ebb74c9b0748/ikuzos-unscripted-podcast"
                                   style="display: inline-block; overflow: hidden; border-radius: 13px; width: 100%;"><img
                                        src="{{asset('images/amazon.png')}}"
                                        alt="Listen on Amazon Podcasts"
                                        style="border-radius: 13px; width: 100%;"></a>
                            </div>
                            <div class="col-12 mt-3">
                                <a href="https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy82YzBjYzhmMC9wb2RjYXN0L3Jzcw"
                                   style="display: inline-block; overflow: hidden; border-radius: 13px; width: 100%;"><img
