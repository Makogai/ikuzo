...
<div class="super_container">
    ...
    <div class="home">
        <div class="background_image"
             style="background-image:url(images/rem.jpg); filter: blur(7px); transform: scale(1.1); box-shadow:inset 0 0 0 2000px rgba(0, 0, 255, 0.3);"></div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="home_content">
                            ...
                            <div class="home_title"><h1>Season 1 Episode 1 available.</h1></div>
                            <div class="home_subtitle">Check out my latest podcast a massive interview with John Doe
                            </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
                href="https://makogai.xyz" target="_blank">Makogai</a>
